    ...
    "musicas": {
        ...
        items: [
            ...
            },
            {
                ...
                description: "Trilha sonora interestelar. Feito exclusivamente com síntese sonora e efeitos digitais.<br>Ouça pelo <a href='https://on.soundcloud.com/7FRyd7Ypc0UvA7Wl0s' target='_blank' rel='noopener'>Soundcloud</a>."
            }
        ]
    },
    "textos": {
        ...
        items: [
            {
                ...
                description: "Um pedal de guitarra multiefeito digital robusto, construído com o MCU Daisy Seed. Ele oferece uma distorção peculiar, baseada em wavefolding, redução de sample rate e um delay com LFO."
            },
            {
                type: "custom",
                customContent: '<p id="big-interrogation">?</p>',
                title: "Menis Dub Siren (em produção)",
                description: "Um sintetizador digital minúsculo, mas poderoso, construído com o MCU Daisy Seed. Ele reinventa as clássicas sirenes do Dub Reggae. A combinação de 8 LFOs, um filtro ressonante com frequência de corte variável e controle de decay e pitch possibilita uma gama abrangente de timbres."
            }
        ]
    },
    "softwares": {
        title: "softwares",
        description: [
            "Instrumentos e interfaces de expressões musicais digitais."
        ],
        items: [
            {
                type: "placeholder",
                title: "Condusom",
                description: "Desenvolvido em python, Condusom é um sintetizador digital controlado pela webcam. Mostre a sua mão para a câmera e conduza o som com gestos e movimentos precisos.<br>Acesse pelo <a href='https://github.com/uspaudiotech/condusom' target='_blank' rel='noopener'>Github</a>."
            },
            {
                type: "placeholder",
                title: "Do Zero ao Som: Criando Áudio Digital com Python",
                description: "Um breve material em Jupyter Notebook destinado para o workshop sobre síntese sonora digital do grupo de extensão acadêmico USPAudioTech.<br>Acesse pelo <a href='https://github.com/uspaudiotech/workshop-sintese' target='_blank' rel='noopener'>Github</a>."
            }
        ]
    },
    "pesquisas": {
